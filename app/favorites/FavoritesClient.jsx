...
export default function FavoritesClient() {
  ...
  const remove = (id) => setFavorites(favorites.filter(x => String(x) !== String(id)));
    ...
    <section className="mx-auto max-w-7xl px-4 py-10">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <button onClick={() => setFavorites([])} className="rounded-2xl border border-gray-300 bg-white px-4 py-2 font-semibold hover:bg-gray-50">Clear All</button>
        </div>
      </div>
